...
class ImageHostingHttpRequestHandler(AdvancedHTTPRequestHandler):
    """
    Using Httprequest to get images from given URL.
    """
    ...
    def __init__(self, request, client_address, server) -> None:
        """
        Using to get, upload, delete images.
        """
        self.get_routes = {
        ...
        """
        Calls the initialization method from the parent class. 
        """
    ...
    def get_images(self) -> None:
        """
        Checks for images, sorts and displays information about them.
        """
    ...
    def post_upload(self):
        """
        Checks conditions for loading images. Returns the loading result.
        """
    ...
    def delete_image(self) -> None:
        """
        Searches for an image to delete. Returns the result of deletion.
        """
